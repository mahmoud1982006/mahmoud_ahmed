...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0072B1?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/mahmoud-ahmed-fathy1/)
[![Email](https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:mahmoud.ahmed.soc@gmail.com)
...
This repository documents my learning journey through hands-on labs, technical reports, and security projects completed while studying cybersecurity. Each project demonstrates practical skills in network security, incident response, Linux, and security analysis.
...
| **NIST Cybersecurity Framework (CSF)** | Applying the Identify, Protect, Detect, Respond, and Recover functions in incident analysis. |
...
| **TCP** | Understanding connection establishment, three-way handshake, and SYN Flood attacks. |
...
| **SSH** | Secure remote access fundamentals. |
...
| Project | Description |
|---------|-------------|
| [Analysis of Network Hardening](./analysis-of-network-hardening/) | Security hardening assessment and recommendations. |
